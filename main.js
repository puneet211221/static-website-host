...
function addCartClicked(event){
  ...
  var product_Img=shopProduct.getElementsByClassName('product-img')[0].src;

  // console.log(title,price,product_Img);
...
var cartBoxContent=`<img src="${product_Img}" alt="" class="cart-img">
                    <div class="detail-box">
                    <div class="cart-product-title">${title}</div>
                    <div class="cart-price">${price}</div>
                     <input type="number" value="0"  min="0" class="cart-quantity">
                    </div>
                    <!-- Remove cart -->
